...
public class WebFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        isType = getArguments().getString("type");
        url = getArguments().getString("url");
        // Inflate the layout for this fragment
        view= inflater.inflate(R.layout.fragment_web, container, false);
        activity=getActivity();
       // ((home)activity).getSupportActionBar().hide();
        ivBookMark=((home)activity).findViewById(R.id.ivBookMark);
      ...
      //  ivBookMark = view.findViewById(R.id.ivBookMark);
        view.findViewById(R.id.ivBookMark).setVisibility(View.GONE);
        if (page == null) {
        ...
        page.setWebViewClient(new WebViewClient() {//it seems not setting webclient, launches
            ...
            public void onPageStarted(final WebView webview, final String url, Bitmap favicon) {
                new Handler(Looper.getMainLooper()).post(new Runnable() {
                    @Override
                    public void run() {
                        EditText urlBox = view.findViewById(R.id.et_search_bar);
                        urlBox.setText(url);
        ...
        page.loadUrl(url);
        loadedFirsTime = true;
        view.findViewById(R.id.btn_home).setVisibility(View.GONE);
...
/*        videoFoundTV = findViewById(R.id.videoFoundTV);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId()==R.id.llDesktop){
            Utils.setDesktopMode(page,true);
        }
        if (item.getItemId()==R.id.llMobile){
            Utils.setDesktopMode(page,false);
        }
